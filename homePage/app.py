...
@app.route('/features')
def features():
    return render_template('features.html', title="LawBot - Features")

@app.route('/about')
def about():
    return render_template('about.html', title="LawBot - about")

@app.route('/contact')
def contact():
    return render_template('contact.html', title="LawBot - contact")
